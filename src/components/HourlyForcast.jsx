    ...
    const renderData = data?.slice(2, 7).map((val) => {
        ...
        return (
            <motion.div
                ...
                whileTap={{ scale: 0.94 }}
                className={`w-full rounded-xl p-2 flex flex-col items-center shadow-md hover:shadow-lg transition-all duration-300 ${!isBlack
            ...
            >
                {/* Temperature */}
                <div
                    className={`${!isBlack ? "text-gray-700" : "text-blue-700"
                        } font-bold mb-2`}
                ...
                <motion.div
                    ...
                    className={`w-12 h-12 rounded-full flex items-center justify-center mb-2 shadow-inner ${!isBlack
